...
| /repositories/{username}/{repo_slug}/pullrequests/{pull_request_id} | `GET` | PullRequestResource.GetPullRequest() | no
| /repositories/{username}/{repo_slug}/pullrequests/{pull_request_id} | `PUT` | none | no
| /repositories/{username}/{repo_slug}/pullrequests/{pull_request_id}/activity | `GET` | PullRequestResource.GetPullRequestActivity() | no
...
| /repositories/{username}/{repo_slug}/pullrequests/{pull_request_id}/comments | `GET` | PullRequestResource.ListPullRequestComments() | no
...
| /repositories/{username}/{repo_slug}/pullrequests/{pull_request_id}/comments/{comment_id} | `GET` | PullRequestResource.GetPullRequestComment(int) | no
...
| /repositories/{username}/{repo_slug}/pullrequests/{pull_request_id}/commits | `GET` | PullRequestResource.ListPullRequestCommits() | no
| /repositories/{username}/{repo_slug}/pullrequests/{pull_request_id}/decline | `POST` | PullRequestResource.DeclinePullRequest() | no
| /repositories/{username}/{repo_slug}/pullrequests/{pull_request_id}/diff | `GET` | PullRequestResource.GetDiffForPullRequest() | no

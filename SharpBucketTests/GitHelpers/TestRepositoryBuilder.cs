...
namespace SharpBucketTests.GitHelpers
{
    ...
    internal class TestRepositoryBuilder : IDisposable
    {
        ...
        public TestRepositoryInfo FillRepository()
        {
            ...
            {
                File.WriteAllText($"{WorkingDirectory}\\readme.md", "This is a test repo generated by the SharpBucket unit tests");
                ...
                var commit = repository.Commit("Initial commit", testSignature, testSignature);
                info.FirstCommit = commit.Sha;
